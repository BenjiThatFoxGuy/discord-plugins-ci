...
function Updater() {
    ...
    return (
        <SettingsTab title="Benjicord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Benjicord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Benjicord automatically updates"
